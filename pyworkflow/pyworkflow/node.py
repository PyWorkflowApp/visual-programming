...
class ViewNode(Node):
    """ViewNodes deal with ui representation of the data in the Workflow.
...
class TabularViewNode(ViewNode):
    """TabularViewNode displays csv data in tabular form.
...
class GraphicalViewNode(ViewNode):
    """GraphicalViewNode displays csv data in graphical form.
